...
const Sidebar = () => {
  ...
  return (
    <div className="w-[20%] h-screen bg-Bar pb-12 overflow-y-scroll scrollbar flex flex-col items-center scrollbar-track-transparent scrollbar-thumb-Foundation">
